        ...
        <SlickSlider {...settings} ref={sliderRef}>
          <div className="slide">
            ...
            <blockquote>
              ...
              экспертом в своё деле&quot;. Преподавательский состав, а в
              частности мой куратор Сторожева Мария Евгеньевна навсегда
              останутся в моём сердце, так как на протяжении целых 4 лет они
              вкладывали в меня свои знания и опыт, тратив на это много сил, я
              могу с полной уверенностью на данный момент сказать, что всё это
              было не зря. Урок от института, который я усвоил на всю жизнь, это
              главное &quot;не стоять на месте&quot;. Чем больше ты делаешь, тем
              больше у тебя получается.
            </blockquote>
          </div>
          <div className="slide">
            <div className="slide__top">
