                ...
                <li className="news__preview">
                  <a href="/">
                    ...
                    <div className="news__bottom">
                      ...
                      <p className="text news__text">
                        В случае если после завершения зачисления (после 17
                        августа) остаются незаполненные места, СахГУ на
                        основании конкурсных списков проводит дополнительное
                        зачисление на указанные места в следующие сроки:
                        <br />
            ...
            <div className="wrapper">
              <div className="your-beginning__container">
                ...
                <p className="big-text">
                  ...
                  выпускать высококлассных специалистов, которым открыты дороги
                  во все перспективные направления деятельности.
                  <br />
                  <br />
                  Сегодня Сахалинский государственный университет является
                  современным образовательным, научным и мультикультурным
                  центром, что делает востребованными выпускников СахГУ не
                  только в России, но и в странах АТР.
                </p>
              ...
              <Parallax
                ...
                <div className="features__list">
                  <ScrollAnimation
                    ...
                    гуманитарным, экономическим, инженерно-техническим
                    направлениям.
                  </ScrollAnimation>
                  <ScrollAnimation
                    animateIn="animate__fadeInUp"
                ...
                <div className="uniqueness__container">
                  <div>
                    ...
                    <p className="text uniqueness__text">
                      Университет — это точка для развития и притяжения
                      островной молодежи.
                      <br />
                      <br />
                  ...
                  <div>
                    ...
                    <p className="text uniqueness__text">
                      ...
                      успеваемость, достижения в научной, общественной,
                      спортивной или культурно-творческой деятельности достигает
                      <b> 20&nbsp;000&nbsp;₽</b> в месяц.
                      <br />
                      <br />
                      Помимо этого, студенты могут получать социальные, именные
                      и другие стипендии.
                    </p>
                  </div>
                </div>
          ...
          <div className="wrapper">
            <div className="parting-words__container">
              ...
              <blockquote>
                ...
                российском рынке труда. Мы ведем активную работу по обмену
