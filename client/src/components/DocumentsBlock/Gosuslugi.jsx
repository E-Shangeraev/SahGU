...
const Gosuslugi = () => (
  <div className="documents-block documents-block--gosuslugi">
    ...
    <p className="documents-block__text">
      ...
      уже есть. Аккаунт на портале должен быть подтвержденный.
    </p>
    <p className="documents-block__text">
      Далее либо на главной странице нажать на &quot;Поступайте в вуз
      онлайн&quot; и следовать подсказками, или нажать на строчку
      &quot;Жизненные ситуации&quot;, &quot;Все услуги&quot;,
      &quot;Образование&quot;, &quot;Подача заявления на поступление в вуз&quot;
    </p>
    <p className="documents-block__text">
